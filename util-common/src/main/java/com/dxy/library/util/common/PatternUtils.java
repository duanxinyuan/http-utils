...
public class PatternUtils {
    ...
    public static boolean matches(PatternEnum patternType, String value) {
        ...
        switch (patternType) {
            ...
            case IP:
                ...
                break;
            case MOBILE:
                result = COMPILE_MOBILE_CHINESE_MAINLAND.matcher(value).matches();
                break;
            case DIGIT:
    ...
    public static boolean isEmail(String email) {
        return PatternUtils.matches(PatternEnum.EMAIL, email);
    }
     ...
     * 检测手机号是否是中国大陆手机号
     */
    public static boolean isMobileOfChineseMainland(String mobile) {
        return PatternUtils.matches(PatternEnum.MOBILE, mobile);
    }
    ...
    public static boolean isContainChinese(String str) {
        return PatternUtils.matches(PatternEnum.CHINESE, str);
    }
    ...
    public static boolean isDigit(String str) {
        return PatternUtils.matches(PatternEnum.DIGIT, str);
    }
    ...
    public static boolean hasDigit(String str) {
        return PatternUtils.matches(PatternEnum.DIGIT_CONTAINS, str);
    }
